	...
	if ( $show_site_info ):
		...
		<div class="site-info">
			...
			$site_info_default = apply_filters( 'getwid_base_site_info',
				_x( '%2$s &copy; %1$s. Все права защищены.<br> <span style="font-size: .875em"><a href="https://androidprog.com/" target="_blank" title="Игры и программы для андроид">Androidprog.com</a></span>', 'Default footer text. %1$s - current year, %2$s - site title.', 'getwid-base' )
			);
